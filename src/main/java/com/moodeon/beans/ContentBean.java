...
public class ContentBean {
    ...
    private String content_file; //업로드 파일명
    private MultipartFile upload_file; // 업로드 파일 데이터
    private int content_writer_idx; //게시글 작성자 인덱스
    private int content_board_idx; //게시판 인덱스
